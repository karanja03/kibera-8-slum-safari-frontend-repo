...
function FounderMessage(){
    return(
        ...
        <div className="card mb-5 mt-5 p-5 howewereest bg-gray-100 shadow-lg py-24 px-14" style={{maxWidth:"1500px"}}>
  <h5 className="card-header text-xl font-semibold">A MESSAGE FROM OUR FOUNDER DR.NOELLE MAINGI</h5>
